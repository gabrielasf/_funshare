          ...
          <div className="container allusers">
            <div className="card allusers border-0 my-5">
              <div className="card-body m-0 p-7">
                <h1 className="font-weight-light card-header bg-info">
                  Players gonna play.
                </h1>
                <br />
                <p className="lead">
                  Use one or more of the search fields below to find your next
                  ally... or oponent!
                </p>
                <div className="form-group mx-1">
                  <label
                    className="mr-2 inline font-weight-light small"
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <input
                        ...
                        className="form-control"
                        placeholder="Game's Language"
                      />
                    </div>
                    <div>
                      <button
                        className="btn btn-outline-info mx-3"
                        onClick={this.searchByMultiple}
                      >
                        Search
                      </button>
                    </div>
                          ...
                          <div className="userDisplay shadow border">
                            ...
                            {user.name !== undefined && (
                              <div>
                                <p className="text-center">
                                  I'm <h5 className="d-inline ">{user.name}</h5>{" "}
                                </p>
                              </div>
                            )}
                            ...
                            {user.city !== undefined && (
                              <div>
                                <p className="text-center">
                                  from{" "}
                                  <h5 className="d-inline ">{user.city}</h5>{" "}
                                </p>
                              </div>
                            )}
                                  ...
                                  {user.myGame.map((game, index) => {
                                    return (
                                      <div className="mb-4" key={index}>
                                        {game.myGameName !== "" && (
                                          <div>
                                            <h4 className="btn btn btn-warning">
                                              {game.myGameName}
                                            </h4>
                                          </div>
                                        )}
